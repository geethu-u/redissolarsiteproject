...
import com.redislabs.university.solarproject.script.CompareAndUpdateScript;
...
//        pipeline.sync();
        ...
        script.updateIfGreater(transaction, key, SiteStats.maxWhField, reading.getWhGenerated());
        script.updateIfLess(transaction, key, SiteStats.minWhField, reading.getWhGenerated());
        script.updateIfGreater(transaction, key, SiteStats.maxCapacityField, getCurrentCapacity(reading));
        transaction.exec();
        // END Challenge #3
    }
